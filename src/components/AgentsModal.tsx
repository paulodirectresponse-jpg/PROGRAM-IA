...
const stageLabel=(stage?:string)=>({
  ...
  'structured_output.repair':'Reparo de formato estruturado',
  'requirements.persistence':'Persistência dos requisitos',
  'run.background_handoff':'Execução assumida pelo servidor',
