...
export const AGENT_CONTRACTS:Record<AgentKey,AgentContract>={
  SCOUT:{
    ...
    requiredOutputs:['objective','architecture_summary','requirements','task_graph','risks','verification_plan'],
    allowedTools:['read','search'],
    doneWhen:['objetivo inequívoco','requisitos identificados','tarefas com dependências','arquitetura não limitada pelos arquivos existentes'],
  },
  STUDIO:{
    key:'STUDIO',
    ...
    requiredOutputs:['design_contract','responsive_rules','interaction_requirements','visual_acceptance_criteria'],
    allowedTools:['read','preview'],
    doneWhen:['critérios visuais objetivos','mobile e desktop considerados','estados/interações descritos'],
  },
  FORGE:{
    key:'FORGE',
